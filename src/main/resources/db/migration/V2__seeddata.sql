...
insert into seat (id, name, section_id, available) values (3, '7_6', 1, TRUE);
insert into seat (id, name, section_id, available) values (4, '7_7', 1, TRUE);

insert into seat (id, name, section_id, available) values (5, '1_5', 2, TRUE);
